...
**RESUMO**
	...
	Desenvolver um sistema web para comercialização de veículos e paças automotivas, com o propósito de facilitar a divulgação, busca e negociação do mesmo, utilizando tecnologias como HTML, CSS, JavaScript e banco de dados JSON, garantindo uma plataforma funcional, organizada e eficiente tanto para usuários quanto para administradores do sistema.
...
O presente projeto consiste no desenvolvimento de um sistema web voltado a comercialização de veículos peças para veículos, com o objetivo de facilitar a divulgação, busca e gerenciamento do mesmo. O site é desenvolvido utilizando HTML e CSS, proporcionando uma interface simples e intuitiva ao usuário.
	...
	A lógica do sistema é implementada em JavaScript, garantindo o funcionamento das operações, enquanto o armazenamento de dados é realizado por meio de um arquivo JSON, estruturado para organizar as informações. O sistema permite cadastro, consulta, edição e exclusão de veículos, além de funcionalidades de busca e filtragem.
...
| **Renan, Gabriel, Julia** | Desenvolvedor Banco de dados | Modelagem e implementação do banco de dados | JSON |
...
Após a modelagem conceitual, o grupo deverá implementar o banco de dados em JSON, usando a API em JavaScript do projeto.
...
Essa implementação deverá ser realizada por meio do arquivo JSON principal do projeto.
...
* Estrutura JSON utilizada na organização das tabelas  
